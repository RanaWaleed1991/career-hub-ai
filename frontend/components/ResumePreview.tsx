    ...
    try {
      ...
      const opt = {
        ...
        html2canvas: {
          ...
          scale: 4, // Balanced quality and performance
          useCORS: true,
          logging: false,
        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex items-center justify-center">
          <div className="bg-white rounded-lg shadow-2xl p-8 max-w-md mx-4">
            <div className="flex flex-col items-center">
              ...
              {/* Text */}
              <h3 className="text-xl font-bold text-slate-800 mb-2">Generating Your PDF...</h3>
              <p className="text-sm text-slate-600 text-center mb-4">
                Creating high-quality PDF with professional formatting.
              </p>
