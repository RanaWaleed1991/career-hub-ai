  ...
  const plans = {
    weekly: {
      ...
      features: [
        ...
        'Unlimited AI improvements & tailoring',
        'Unlimited cover letters',
        'Unlimited selection criteria documents',
        '10 resume analyses & skill gap audits',
    ...
    monthly: {
      ...
      features: [
        ...
        'Unlimited cover letters',
        'Unlimited selection criteria documents',
        'Unlimited resume analyses & skill gap audits',
        'Clean downloads (no watermark)',
        'Resume version history',
        'Application tracker dashboard',
        'Priority job alerts',
